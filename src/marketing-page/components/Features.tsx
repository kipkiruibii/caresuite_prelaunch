...
const items = [
  ...
  },
  {
    ...
    title: 'Mobile App with Offline Support',
    description:
      'Mobile app for care staff with offline support, enabling access to schedules, tasks, medication management, and client updates even without internet.',
  ...
  return (
    <Container id="features" sx={{ py: { xs: 8, sm: 16 } }}>
      <Box sx={{ width: { sm: '100%', md: '60%' } }}>
        ...
        >
          Discover the powerful features of CareSuite designed to streamline care
          management, enhance communication, and improve overall efficiency for care
          providers and families alike.
        </Typography>
      </Box>
      <Box
        sx={{
